...
│
├── datasets/                # Cleaned & raw datasets
│   ├── job_threat_index.csv
│   ├── chatgpt_growth_and_visits.csv
│   ├── policymap_income_county_clean.csv
│   ├── policymap_education_clean.csv
│   ├── policymap_unemployment_clean.csv
│   └── Public_Opinion_Dataset.csv
│
├── scripts/                 # Python analysis files
│   └── Final_CapstoneProject_JakeGapusan.py
│
├── visualizations/          # Power BI dashboard or exported visuals
│   └── FinalCapstone_PowerBI_JakeGapusan.pbix
│
├── documentation/           # Final written report
│   └── FinalCapstone_Document_JakeGapusan.pdf
│
